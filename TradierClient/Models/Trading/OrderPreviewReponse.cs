...
namespace Tradier.Client.Models.Trading
{
    ...
    public class OrderPreviewResponse : IOrder
    {
        ...
        /// <remarks>
        ///     This property represents the side of an object. It can have different values depending on the context in which it
        ///     is used.
        ///     For example, in a geometric shape, it could represent the side of the shape (e.g. "top", "bottom", "left",
        ///     "right").
        /// </remarks>
