namespace Tradier.Client.Models.Streaming
{
    ...
    public class SummaryStream
    {
        ...
        /// <summary>
        /// Represents the previous closing price of a stock or financial instrument. </summary> <remarks>
        /// The prevClose property stores the value of the previous closing price as a string. </remarks>
        /// <value>
        /// A string representing the previous closing price. </value>
        /// /
