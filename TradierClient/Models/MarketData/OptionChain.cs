...
namespace Tradier.Client.Models.MarketData
{
    ...
    public class Option
    {
        ...
        [JsonPropertyName("exch")] public string Exchange { get; set; }
        ...
        [JsonPropertyName("prevclose")] public float? PreviousClose { get; set; }
        ...
        [JsonPropertyName("bidexch")] public string BidExchange { get; set; }
        ...
        [JsonPropertyName("askexch")] public string AskExchange { get; set; }
        ...
        [JsonPropertyName("greeks")] public Greeks Greeks { get; set; }
    }
    ...
    public class Greeks
    {
        ...
        [JsonPropertyName("gamma")] public float Gamma { get; set; }

        [JsonPropertyName("theta")] public float Theta { get; set; }

        [JsonPropertyName("vega")] public float Vega { get; set; }

        [JsonPropertyName("rho")] public float Rho { get; set; }

        [JsonPropertyName("phi")] public float Phi { get; set; }

        [JsonPropertyName("bid_iv")] public float BidIV { get; set; }

        [JsonPropertyName("mid_iv")] public float MidIV { get; set; }

        [JsonPropertyName("ask_iv")] public float AskIV { get; set; }

        [JsonPropertyName("smv_vol")] public float SmvIV { get; set; }
