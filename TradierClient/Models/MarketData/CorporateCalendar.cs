...
namespace Tradier.Client.Models.MarketData
{
    ...
    public class CorporateCalendarRootObject
    {
        ...
        /// </value>
        [JsonPropertyName("results")] public List<CorporateCalendarData> Results { get; set; }
    }
    ...
    public class CorporateCalendarData
    {
        ...
        /// </summary>
        [JsonPropertyName("tables")] public CorporateCalendarTable Tables { get; set; }
    }
    ...
    public class CorporateCalendar
    {
        ...
        /// </value>
        [JsonPropertyName("begin_date_time")] public DateTime BeginDateTime { get; set; }
        ...
        /// The event status.
        /// </value>
        [JsonPropertyName("event_status")] public string EventStatus { get; set; }

        /// <summary>
        /// The time zone property specifies the time zone of an object.
        /// </summary>
        /// <value>The time zone.</value>
        [JsonPropertyName("time_zone")] public DateTime TimeZone { get; set; }
    }
}