...
namespace Tradier.Client.Models.Fundamentals
{
    ...
    public class CompanyProfile
    {
        ...
        /// </summary>
        /// <remarks>
        ///     This property is part of the <see cref="CompanyProfile" /> class in the
        ///     <see cref="Tradier.Client.Models.Fundamentals" /> namespace.
    ...
    public class OwnershipSummary
    {
        ...
        ///     The shares outstanding can change over time due to factors such as stock buybacks, stock issuances, and stock
        ///     splits.
        /// </remarks>
