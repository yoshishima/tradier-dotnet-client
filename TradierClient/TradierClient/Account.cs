...
namespace Tradier.Client
{
    ...
    public class Account
    {
        ...
        ///     The account number for which the balances information is requested. If null, the default
        ///     account number will be used.
        /// </param>
        ...
        /// </summary>
        /// <param name="accountNumber">
        ///     The account number for which to retrieve the orders. If not specified, the default account
        ///     number will be used.
        /// </param>
