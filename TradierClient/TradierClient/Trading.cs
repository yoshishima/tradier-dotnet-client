...
namespace Tradier.Client
{
    ...
    public class Trading
    {
        ...
        /// <param name="legs">A list of tuples representing each leg of the multileg order. Each tuple contains the symbol, type, and quantity of the leg</param>
        /// <param name="price">The price of the order (optional)</param>
        /// <param name="preview">Whether it's a preview order (optional)</param>
        /// <returns>Returns a task representing the asynchronous operation. The task will resolve to an object implementing the interface IOrder.</returns>
        ...
        /// <param name="type">The type of the order.</param>
        /// <param name="duration">The duration of the order.</param>
        /// <param name="legs">A list of tuples representing the legs of the order. Each tuple contains the symbol, type, and quantity of the leg.</param>
        ...
        /// <param name="legs">The list of legs for the combo order. Each leg contains the option symbol, side (buy/sell), and quantity.</param>
        /// <param name="price">The price of the combo order. Optional parameter; defaults to null.</param>
        /// <param name="preview">A flag indicating whether to return a preview of the order. Optional parameter; defaults to false.</param>
        /// <returns>
        /// Returns an instance of the IOrder interface representing the placed combo order, or an instance of the IOrderPreviewResponse interface representing a preview of the combo order.
        /// </returns>
        ...
        /// Each tuple should contain the following information: symbol, quantity, action, orderType, price, stopPrice (optional), and limitPrice (optional).
        /// </param>
        ...
        /// <param name="accountNumber">The account number associated with the order.</param>
        /// <param name="duration">The duration of the order.</param>
        /// <param name="legs">A list of tuples representing the legs of the order.
        /// Each tuple should contain the symbol, quantity, type, option symbol, side, price, and stop of the leg.</param>
        /// <param name="preview">Indicates whether the order is a preview. Default value is false.</param>
        /// <returns>Returns a Task object representing the asynchronous operation. The task result is
        /// either an IOrder object or an OrderPreview object.</returns>
        ...
        /// </summary>
        /// <param name="duration">The duration of the order.</param>
        /// <param name="legs">A list of tuples representing individual orders in the one-cancels-other order. Each tuple contains the following elements:
        /// <list type="bullet">
        /// <item>
        ...
        /// <returns>
        /// A Task representing the asynchronous operation. The task result will be an IOrder object representing the placed one-cancels-other order.
        /// </returns>
        ...
        /// <param name="duration">The duration of the order.</param>
        /// <param name="legs">The list of legs (sub-orders) in the OCO order. Each leg is represented by a tuple containing symbol, quantity, order type, option symbol, side, price, and stop.</param>
        /// <param name="preview">Optional. Indicates whether to preview the order or directly place it. Default is false.</param>
        /// <returns>
        /// Returns an awaitable task that represents the asynchronous operation. The task result contains the order which can be either a real order or a preview response.
        /// </returns>
        ...
        /// </summary>
        /// <param name="duration">The duration of the order.</param>
        /// <param name="legs">A list of tuples representing the individual orders in the OTOCO order.
        /// Each tuple consists of (symbol, quantity, side, priceType, timeInForce, price, stopPrice).</param>
        ...
        /// <param name="legs">The list of order leg tuples containing symbol, quantity, type, option symbol, side, price, and stop.</param>
